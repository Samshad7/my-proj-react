  ...
  return (
    <>
      ...
      <p>
        ...
        of paragraphs to see if they are beneficial to your current project.
      </p>

      <p>
        If you do find this paragraph tool useful, please do us a favor and let
        us know how you're using it. It's greatly beneficial for us to know the
        ...
        note on what you'd like to see changed or added to make it better in the
        future.
      </p>
    </>
  );
